...
namespace ConsoleApp1
{
    static class UI
    {
        ...
        {
            Console.WriteLine($"Название оборудования = {оборудование.Название}");
            Console.WriteLine($"Стоимость оборудования = {оборудование.Стоимость}");
            Console.WriteLine($"Дата постановки на баланс = {оборудование.ДатаПостановкиНаБаланс}");
        }
    }
}
